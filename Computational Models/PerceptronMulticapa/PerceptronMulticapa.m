...
ECM_point = MSEAcumuladoTest_vector(indiceParada);
plot(indiceParada , MSEAcumuladoTest_vector(indiceParada), 'or')
legend('MSE Entrenamiento', 'MSE Validación', 'MSE Test en mejor época')

figure;
plot(Z, 'or');  % Gráfica de los valores objetivos
xlabel('Índice de los patrones');
ylabel('Valor objetivo (clase)');
title('Valores Objetivos de los Patrones');