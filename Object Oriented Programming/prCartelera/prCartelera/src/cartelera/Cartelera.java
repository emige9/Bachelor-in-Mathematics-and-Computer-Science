	...
	public void leerCartelera(Scanner sc) {
		while (sc.hasNextLine()) {
			...
			try {
				...
				throw new CarteleraException("La duración de la película o la hora de la sesión descrito en la línea " +
											linea + " no tienen formato númérico correcto");
			} catch (NoSuchElementException nsee) {
				throw new CarteleraException("El formato de la línea: " + linea + " no es correcto");
				...
				throw new CarteleraException(mensaje + " en la línea " + linea);
			} finally {
				scLinea.close();
			}
		}
